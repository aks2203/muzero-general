...
class MuZero:
    ...
    def test(
        self, opponent_muzero, render=True, opponent='rnn-test', muzero_player=None, num_tests=1, num_gpus=0):
        """
        ...
        self_play_worker = self_play.SelfPlay.options(
            num_cpus=0, num_gpus=num_gpus,
        ).remote(self.checkpoint, self.Game, self.config, numpy.random.randint(10000), opponent_config=opponent_muzero.config, opponent_checkpoint=opponent_muzero.checkpoint)
        results = []
