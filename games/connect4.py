...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Training
        self.results_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "../results", os.path.basename(__file__)[:-3], uuid.uuid1().hex)  # Path to store the model weights and TensorBoard logs
